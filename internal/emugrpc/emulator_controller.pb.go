...
func (KeyboardEvent_KeyEventType) EnumDescriptor() ([]byte, []int) {
	return file_emulator_controller_proto_rawDescGZIP(), []int{17, 1}
}
...
func (BatteryState_BatteryHealth) EnumDescriptor() ([]byte, []int) {
	return file_emulator_controller_proto_rawDescGZIP(), []int{23, 2}
}
...
func (AudioFormat_SampleFormat) EnumDescriptor() ([]byte, []int) {
	return file_emulator_controller_proto_rawDescGZIP(), []int{34, 0}
}
...
func (AudioFormat_Channels) EnumDescriptor() ([]byte, []int) {
	return file_emulator_controller_proto_rawDescGZIP(), []int{34, 1}
}
...
func (AudioFormat_DeliveryMode) EnumDescriptor() ([]byte, []int) {
	return file_emulator_controller_proto_rawDescGZIP(), []int{34, 2}
}
...
func (DisplayConfiguration_DisplayFlags) EnumDescriptor() ([]byte, []int) {
	return file_emulator_controller_proto_rawDescGZIP(), []int{37, 0}
}
...
func (Notification_EventType) EnumDescriptor() ([]byte, []int) {
	return file_emulator_controller_proto_rawDescGZIP(), []int{39, 0}
}
...
func (Posture_PostureValue) EnumDescriptor() ([]byte, []int) {
	return file_emulator_controller_proto_rawDescGZIP(), []int{48, 0}
}
...
const file_emulator_controller_proto_rawDesc = "" +
	...
	"NO_SERVICE\x10\xfd\xff\xff\xff\xff\xff\xff\xff\xff\x01\x12\x15\n" +
	"\bDISABLED\x10\xfe\xff\xff\xff\xff\xff\xff\xff\xff\x01\x12\x14\n" +
	"\aUNKNOWN\x10\xff\xff\xff\xff\xff\xff\xff\xff\xff\x01\"\x95\x02\n" +
	"\n" +
	"SensorType\x12\x10\n" +
	...
	"\x19ACCELERATION_UNCALIBRATED\x10\x11\"\xa5\x01\n" +
	...
	"\framSizeBytes\x18\x03 \x01(\x03R\framSizeBytes\"Y\n" +
	...
	"\x16xr_head_velocity_event\x18\r \x01(\v2#.android.emulation.control.VelocityH\x00R\x13xrHeadVelocityEventB\x06\n" +
	"\x04type\"f\n" +
	...
	"\fgetXrOptions\x12\x16.google.protobuf.Empty\x1a$.android.emulation.control.XrOptions\"\x00B&\n" +
...
var file_emulator_controller_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_emulator_controller_proto_goTypes = []any{
	...
	(*PenEvent)(nil),                                 // 43: android.emulation.control.PenEvent
	(*MouseEvent)(nil),                               // 44: android.emulation.control.MouseEvent
	(*WheelEvent)(nil),                               // 45: android.emulation.control.WheelEvent
	(*KeyboardEvent)(nil),                            // 46: android.emulation.control.KeyboardEvent
	(*XrCommand)(nil),                                // 47: android.emulation.control.XrCommand
	(*InputEvent)(nil),                               // 48: android.emulation.control.InputEvent
	(*AndroidEvent)(nil),                             // 49: android.emulation.control.AndroidEvent
	(*Fingerprint)(nil),                              // 50: android.emulation.control.Fingerprint
	(*GpsState)(nil),                                 // 51: android.emulation.control.GpsState
	(*BatteryState)(nil),                             // 52: android.emulation.control.BatteryState
	(*ImageTransport)(nil),                           // 53: android.emulation.control.ImageTransport
	(*FoldedDisplay)(nil),                            // 54: android.emulation.control.FoldedDisplay
	(*ImageFormat)(nil),                              // 55: android.emulation.control.ImageFormat
	(*Image)(nil),                                    // 56: android.emulation.control.Image
	(*Rotation)(nil),                                 // 57: android.emulation.control.Rotation
	(*PhoneCall)(nil),                                // 58: android.emulation.control.PhoneCall
	(*PhoneResponse)(nil),                            // 59: android.emulation.control.PhoneResponse
	(*Entry)(nil),                                    // 60: android.emulation.control.Entry
	(*EntryList)(nil),                                // 61: android.emulation.control.EntryList
	(*EmulatorStatus)(nil),                           // 62: android.emulation.control.EmulatorStatus
	(*AudioFormat)(nil),                              // 63: android.emulation.control.AudioFormat
	(*AudioPacket)(nil),                              // 64: android.emulation.control.AudioPacket
	(*SmsMessage)(nil),                               // 65: android.emulation.control.SmsMessage
	(*DisplayConfiguration)(nil),                     // 66: android.emulation.control.DisplayConfiguration
	(*DisplayConfigurations)(nil),                    // 67: android.emulation.control.DisplayConfigurations
	(*Notification)(nil),                             // 68: android.emulation.control.Notification
	(*BootCompletedNotification)(nil),                // 69: android.emulation.control.BootCompletedNotification
	(*CameraNotification)(nil),                       // 70: android.emulation.control.CameraNotification
	(*TextViewFocus)(nil),                            // 71: android.emulation.control.TextViewFocus
	(*DisplayConfigurationsChangedNotification)(nil), // 72: android.emulation.control.DisplayConfigurationsChangedNotification
	(*RotationRadian)(nil),                           // 73: android.emulation.control.RotationRadian
	(*Translation)(nil),                              // 74: android.emulation.control.Translation
	(*AngularVelocity)(nil),                          // 75: android.emulation.control.AngularVelocity
	(*Velocity)(nil),                                 // 76: android.emulation.control.Velocity
	(*Posture)(nil),                                  // 77: android.emulation.control.Posture
	(*PhoneNumber)(nil),                              // 78: android.emulation.control.PhoneNumber
	nil,                                              // 79: android.emulation.control.EmulatorStatus.GuestConfigEntry
...
var file_emulator_controller_proto_depIdxs = []int32{
	...
	41,  // 17: android.emulation.control.PenEvent.events:type_name -> android.emulation.control.Pen
	12,  // 18: android.emulation.control.KeyboardEvent.codeType:type_name -> android.emulation.control.KeyboardEvent.KeyCodeType
	13,  // 19: android.emulation.control.KeyboardEvent.eventType:type_name -> android.emulation.control.KeyboardEvent.KeyEventType
	14,  // 20: android.emulation.control.XrCommand.action:type_name -> android.emulation.control.XrCommand.Action
	46,  // 21: android.emulation.control.InputEvent.key_event:type_name -> android.emulation.control.KeyboardEvent
	42,  // 22: android.emulation.control.InputEvent.touch_event:type_name -> android.emulation.control.TouchEvent
	44,  // 23: android.emulation.control.InputEvent.mouse_event:type_name -> android.emulation.control.MouseEvent
	49,  // 24: android.emulation.control.InputEvent.android_event:type_name -> android.emulation.control.AndroidEvent
	43,  // 25: android.emulation.control.InputEvent.pen_event:type_name -> android.emulation.control.PenEvent
	45,  // 26: android.emulation.control.InputEvent.wheel_event:type_name -> android.emulation.control.WheelEvent
	44,  // 27: android.emulation.control.InputEvent.xr_hand_event:type_name -> android.emulation.control.MouseEvent
	44,  // 28: android.emulation.control.InputEvent.xr_eye_event:type_name -> android.emulation.control.MouseEvent
	47,  // 29: android.emulation.control.InputEvent.xr_command:type_name -> android.emulation.control.XrCommand
	73,  // 30: android.emulation.control.InputEvent.xr_head_rotation_event:type_name -> android.emulation.control.RotationRadian
	74,  // 31: android.emulation.control.InputEvent.xr_head_movement_event:type_name -> android.emulation.control.Translation
	75,  // 32: android.emulation.control.InputEvent.xr_head_angular_velocity_event:type_name -> android.emulation.control.AngularVelocity
	76,  // 33: android.emulation.control.InputEvent.xr_head_velocity_event:type_name -> android.emulation.control.Velocity
	16,  // 34: android.emulation.control.BatteryState.charger:type_name -> android.emulation.control.BatteryState.BatteryCharger
	17,  // 35: android.emulation.control.BatteryState.health:type_name -> android.emulation.control.BatteryState.BatteryHealth
	15,  // 36: android.emulation.control.BatteryState.status:type_name -> android.emulation.control.BatteryState.BatteryStatus
	18,  // 37: android.emulation.control.ImageTransport.channel:type_name -> android.emulation.control.ImageTransport.TransportChannel
	19,  // 38: android.emulation.control.ImageFormat.format:type_name -> android.emulation.control.ImageFormat.ImgFormat
	57,  // 39: android.emulation.control.ImageFormat.rotation:type_name -> android.emulation.control.Rotation
	53,  // 40: android.emulation.control.ImageFormat.transport:type_name -> android.emulation.control.ImageTransport
	54,  // 41: android.emulation.control.ImageFormat.foldedDisplay:type_name -> android.emulation.control.FoldedDisplay
	0,   // 42: android.emulation.control.ImageFormat.displayMode:type_name -> android.emulation.control.DisplayModeValue
	55,  // 43: android.emulation.control.Image.format:type_name -> android.emulation.control.ImageFormat
	20,  // 44: android.emulation.control.Rotation.rotation:type_name -> android.emulation.control.Rotation.SkinRotation
	21,  // 45: android.emulation.control.PhoneCall.operation:type_name -> android.emulation.control.PhoneCall.Operation
	22,  // 46: android.emulation.control.PhoneResponse.response:type_name -> android.emulation.control.PhoneResponse.Response
	60,  // 47: android.emulation.control.EntryList.entry:type_name -> android.emulation.control.Entry
	38,  // 48: android.emulation.control.EmulatorStatus.vmConfig:type_name -> android.emulation.control.VmConfiguration
	61,  // 49: android.emulation.control.EmulatorStatus.hardwareConfig:type_name -> android.emulation.control.EntryList
	79,  // 50: android.emulation.control.EmulatorStatus.guestConfig:type_name -> android.emulation.control.EmulatorStatus.GuestConfigEntry
	24,  // 51: android.emulation.control.AudioFormat.channels:type_name -> android.emulation.control.AudioFormat.Channels
	23,  // 52: android.emulation.control.AudioFormat.format:type_name -> android.emulation.control.AudioFormat.SampleFormat
	25,  // 53: android.emulation.control.AudioFormat.mode:type_name -> android.emulation.control.AudioFormat.DeliveryMode
	63,  // 54: android.emulation.control.AudioPacket.format:type_name -> android.emulation.control.AudioFormat
	66,  // 55: android.emulation.control.DisplayConfigurations.displays:type_name -> android.emulation.control.DisplayConfiguration
	27,  // 56: android.emulation.control.Notification.event:type_name -> android.emulation.control.Notification.EventType
	70,  // 57: android.emulation.control.Notification.cameraNotification:type_name -> android.emulation.control.CameraNotification
	72,  // 58: android.emulation.control.Notification.displayConfigurationsChangedNotification:type_name -> android.emulation.control.DisplayConfigurationsChangedNotification
	77,  // 59: android.emulation.control.Notification.posture:type_name -> android.emulation.control.Posture
	69,  // 60: android.emulation.control.Notification.booted:type_name -> android.emulation.control.BootCompletedNotification
	33,  // 61: android.emulation.control.Notification.brightness:type_name -> android.emulation.control.BrightnessValue
	71,  // 62: android.emulation.control.Notification.textViewFocus:type_name -> android.emulation.control.TextViewFocus
	35,  // 63: android.emulation.control.Notification.xrOptions:type_name -> android.emulation.control.XrOptions
	67,  // 64: android.emulation.control.DisplayConfigurationsChangedNotification.displayConfigurations:type_name -> android.emulation.control.DisplayConfigurations
	28,  // 65: android.emulation.control.Posture.value:type_name -> android.emulation.control.Posture.PostureValue
	32,  // 66: android.emulation.control.EmulatorController.streamSensor:input_type -> android.emulation.control.SensorValue
	32,  // 67: android.emulation.control.EmulatorController.getSensor:input_type -> android.emulation.control.SensorValue
	32,  // 68: android.emulation.control.EmulatorController.setSensor:input_type -> android.emulation.control.SensorValue
	31,  // 69: android.emulation.control.EmulatorController.setPhysicalModel:input_type -> android.emulation.control.PhysicalModelValue
	31,  // 70: android.emulation.control.EmulatorController.getPhysicalModel:input_type -> android.emulation.control.PhysicalModelValue
	31,  // 71: android.emulation.control.EmulatorController.streamPhysicalModel:input_type -> android.emulation.control.PhysicalModelValue
	39,  // 72: android.emulation.control.EmulatorController.setClipboard:input_type -> android.emulation.control.ClipData
	80,  // 73: android.emulation.control.EmulatorController.getClipboard:input_type -> google.protobuf.Empty
	80,  // 74: android.emulation.control.EmulatorController.streamClipboard:input_type -> google.protobuf.Empty
	52,  // 75: android.emulation.control.EmulatorController.setBattery:input_type -> android.emulation.control.BatteryState
	80,  // 76: android.emulation.control.EmulatorController.getBattery:input_type -> google.protobuf.Empty
	51,  // 77: android.emulation.control.EmulatorController.setGps:input_type -> android.emulation.control.GpsState
	80,  // 78: android.emulation.control.EmulatorController.getGps:input_type -> google.protobuf.Empty
	50,  // 79: android.emulation.control.EmulatorController.sendFingerprint:input_type -> android.emulation.control.Fingerprint
	46,  // 80: android.emulation.control.EmulatorController.sendKey:input_type -> android.emulation.control.KeyboardEvent
	42,  // 81: android.emulation.control.EmulatorController.sendTouch:input_type -> android.emulation.control.TouchEvent
	44,  // 82: android.emulation.control.EmulatorController.sendMouse:input_type -> android.emulation.control.MouseEvent
	45,  // 83: android.emulation.control.EmulatorController.injectWheel:input_type -> android.emulation.control.WheelEvent
	48,  // 84: android.emulation.control.EmulatorController.streamInputEvent:input_type -> android.emulation.control.InputEvent
	58,  // 85: android.emulation.control.EmulatorController.sendPhone:input_type -> android.emulation.control.PhoneCall
	65,  // 86: android.emulation.control.EmulatorController.sendSms:input_type -> android.emulation.control.SmsMessage
	78,  // 87: android.emulation.control.EmulatorController.setPhoneNumber:input_type -> android.emulation.control.PhoneNumber
	80,  // 88: android.emulation.control.EmulatorController.getStatus:input_type -> google.protobuf.Empty
	55,  // 89: android.emulation.control.EmulatorController.getScreenshot:input_type -> android.emulation.control.ImageFormat
	55,  // 90: android.emulation.control.EmulatorController.streamScreenshot:input_type -> android.emulation.control.ImageFormat
	63,  // 91: android.emulation.control.EmulatorController.streamAudio:input_type -> android.emulation.control.AudioFormat
	64,  // 92: android.emulation.control.EmulatorController.injectAudio:input_type -> android.emulation.control.AudioPacket
	36,  // 93: android.emulation.control.EmulatorController.getLogcat:input_type -> android.emulation.control.LogMessage
	36,  // 94: android.emulation.control.EmulatorController.streamLogcat:input_type -> android.emulation.control.LogMessage
	29,  // 95: android.emulation.control.EmulatorController.setVmState:input_type -> android.emulation.control.VmRunState
	80,  // 96: android.emulation.control.EmulatorController.getVmState:input_type -> google.protobuf.Empty
	67,  // 97: android.emulation.control.EmulatorController.setDisplayConfigurations:input_type -> android.emulation.control.DisplayConfigurations
	80,  // 98: android.emulation.control.EmulatorController.getDisplayConfigurations:input_type -> google.protobuf.Empty
	80,  // 99: android.emulation.control.EmulatorController.streamNotification:input_type -> google.protobuf.Empty
	73,  // 100: android.emulation.control.EmulatorController.rotateVirtualSceneCamera:input_type -> android.emulation.control.RotationRadian
	76,  // 101: android.emulation.control.EmulatorController.setVirtualSceneCameraVelocity:input_type -> android.emulation.control.Velocity
	77,  // 102: android.emulation.control.EmulatorController.setPosture:input_type -> android.emulation.control.Posture
	33,  // 103: android.emulation.control.EmulatorController.getBrightness:input_type -> android.emulation.control.BrightnessValue
	33,  // 104: android.emulation.control.EmulatorController.setBrightness:input_type -> android.emulation.control.BrightnessValue
	80,  // 105: android.emulation.control.EmulatorController.getDisplayMode:input_type -> google.protobuf.Empty
	34,  // 106: android.emulation.control.EmulatorController.setDisplayMode:input_type -> android.emulation.control.DisplayMode
	35,  // 107: android.emulation.control.EmulatorController.setXrOptions:input_type -> android.emulation.control.XrOptions
	80,  // 108: android.emulation.control.EmulatorController.getXrOptions:input_type -> google.protobuf.Empty
	32,  // 109: android.emulation.control.EmulatorController.streamSensor:output_type -> android.emulation.control.SensorValue
	32,  // 110: android.emulation.control.EmulatorController.getSensor:output_type -> android.emulation.control.SensorValue
	80,  // 111: android.emulation.control.EmulatorController.setSensor:output_type -> google.protobuf.Empty
	80,  // 112: android.emulation.control.EmulatorController.setPhysicalModel:output_type -> google.protobuf.Empty
	31,  // 113: android.emulation.control.EmulatorController.getPhysicalModel:output_type -> android.emulation.control.PhysicalModelValue
	31,  // 114: android.emulation.control.EmulatorController.streamPhysicalModel:output_type -> android.emulation.control.PhysicalModelValue
	80,  // 115: android.emulation.control.EmulatorController.setClipboard:output_type -> google.protobuf.Empty
	39,  // 116: android.emulation.control.EmulatorController.getClipboard:output_type -> android.emulation.control.ClipData
	39,  // 117: android.emulation.control.EmulatorController.streamClipboard:output_type -> android.emulation.control.ClipData
	80,  // 118: android.emulation.control.EmulatorController.setBattery:output_type -> google.protobuf.Empty
	52,  // 119: android.emulation.control.EmulatorController.getBattery:output_type -> android.emulation.control.BatteryState
	80,  // 120: android.emulation.control.EmulatorController.setGps:output_type -> google.protobuf.Empty
	51,  // 121: android.emulation.control.EmulatorController.getGps:output_type -> android.emulation.control.GpsState
	80,  // 122: android.emulation.control.EmulatorController.sendFingerprint:output_type -> google.protobuf.Empty
	80,  // 123: android.emulation.control.EmulatorController.sendKey:output_type -> google.protobuf.Empty
	80,  // 124: android.emulation.control.EmulatorController.sendTouch:output_type -> google.protobuf.Empty
	80,  // 125: android.emulation.control.EmulatorController.sendMouse:output_type -> google.protobuf.Empty
	80,  // 126: android.emulation.control.EmulatorController.injectWheel:output_type -> google.protobuf.Empty
	80,  // 127: android.emulation.control.EmulatorController.streamInputEvent:output_type -> google.protobuf.Empty
	59,  // 128: android.emulation.control.EmulatorController.sendPhone:output_type -> android.emulation.control.PhoneResponse
	59,  // 129: android.emulation.control.EmulatorController.sendSms:output_type -> android.emulation.control.PhoneResponse
	59,  // 130: android.emulation.control.EmulatorController.setPhoneNumber:output_type -> android.emulation.control.PhoneResponse
	62,  // 131: android.emulation.control.EmulatorController.getStatus:output_type -> android.emulation.control.EmulatorStatus
	56,  // 132: android.emulation.control.EmulatorController.getScreenshot:output_type -> android.emulation.control.Image
	56,  // 133: android.emulation.control.EmulatorController.streamScreenshot:output_type -> android.emulation.control.Image
	64,  // 134: android.emulation.control.EmulatorController.streamAudio:output_type -> android.emulation.control.AudioPacket
	80,  // 135: android.emulation.control.EmulatorController.injectAudio:output_type -> google.protobuf.Empty
	36,  // 136: android.emulation.control.EmulatorController.getLogcat:output_type -> android.emulation.control.LogMessage
	36,  // 137: android.emulation.control.EmulatorController.streamLogcat:output_type -> android.emulation.control.LogMessage
	80,  // 138: android.emulation.control.EmulatorController.setVmState:output_type -> google.protobuf.Empty
	29,  // 139: android.emulation.control.EmulatorController.getVmState:output_type -> android.emulation.control.VmRunState
	67,  // 140: android.emulation.control.EmulatorController.setDisplayConfigurations:output_type -> android.emulation.control.DisplayConfigurations
	67,  // 141: android.emulation.control.EmulatorController.getDisplayConfigurations:output_type -> android.emulation.control.DisplayConfigurations
	68,  // 142: android.emulation.control.EmulatorController.streamNotification:output_type -> android.emulation.control.Notification
	80,  // 143: android.emulation.control.EmulatorController.rotateVirtualSceneCamera:output_type -> google.protobuf.Empty
	80,  // 144: android.emulation.control.EmulatorController.setVirtualSceneCameraVelocity:output_type -> google.protobuf.Empty
	80,  // 145: android.emulation.control.EmulatorController.setPosture:output_type -> google.protobuf.Empty
	33,  // 146: android.emulation.control.EmulatorController.getBrightness:output_type -> android.emulation.control.BrightnessValue
	80,  // 147: android.emulation.control.EmulatorController.setBrightness:output_type -> google.protobuf.Empty
	34,  // 148: android.emulation.control.EmulatorController.getDisplayMode:output_type -> android.emulation.control.DisplayMode
	80,  // 149: android.emulation.control.EmulatorController.setDisplayMode:output_type -> google.protobuf.Empty
	80,  // 150: android.emulation.control.EmulatorController.setXrOptions:output_type -> google.protobuf.Empty
	35,  // 151: android.emulation.control.EmulatorController.getXrOptions:output_type -> android.emulation.control.XrOptions
...
func file_emulator_controller_proto_init() {
	...
	file_emulator_controller_proto_msgTypes[19].OneofWrappers = []any{
	...
	file_emulator_controller_proto_msgTypes[39].OneofWrappers = []any{
